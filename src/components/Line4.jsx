...
export function LineChart4() {
    ...
    const valoresTemp = valores.map((valor) => valor.otroSensor)
    const valoresTempPred = valores.map((valor) => valor.otroSensor + getRandomArbitrary(1, 60))
